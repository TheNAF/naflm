...
$inducements = array (
    ...
    // Added in BB2016 Spike! #2
    'Specialist Assisstant Coaches' => array (
        'cost' => 20000,
        'max'  => 20,
        'reduced_cost' => 20000,
        'reduced_cost_races' => array(),
    ...
    'Druchii Sports Sorceress' => array (
        ...
        'max'  => 1,
        'reduced_cost' => 150000,
        'reduced_cost_races' => array(T_RACE_DARK_ELF, T_RACE_ELF),
    ),		
    // Added in BB2016 Spike! #3
    'Plague Doctors' => array (
        'cost' => 0,
        'max'  => 1,
        'reduced_cost' => 100000,
        'reduced_cost_races' => array(T_RACE_NURGLE, T_RACE_CHAOS_PACT),
    ),
    'Cavorting Nurglings' => array (
        'cost' => 0,
        'max'  => 1,
        'reduced_cost' => 40000,
        'reduced_cost_races' => array(T_RACE_NURGLE),
    ),
    'Plague Horticulturalist of Nurgle' => array (
        'cost' => 0,
        'max'  => 1,
        'reduced_cost' => 150000,
        'reduced_cost_races' => array(T_RACE_NURGLE, T_RACE_CHAOS_PACT, T_RACE_CHAOS),
    ),
    'Joseph Bugman, Dwarf Master Brewer' => array (
        'cost' => 0,
        'max'  => 1,
        'reduced_cost' => 70000,
        'reduced_cost_races' => array(T_RACE_DWARF, T_RACE_HALFLING, T_RACE_NORSE, T_RACE_HUMAN, T_RACE_AMAZON, T_RACE_OGRE),
    ),	
    // Added in BB2016 Spike! #4
